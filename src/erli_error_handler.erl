...
gen_body(405, Req, _Reason) ->
    {<<"{\"errors\":{\"message\":\"Method not allowed, use an OPTIONS request to find out what methods are supported by the resource.\", \"status_code\":405}}">>,
     Req};
gen_body(410, Req, _Reason) ->
    {<<"{\"errors\":{\"message\":\"Resource gone. The resource identified by this URL has been permanetly removed.\", \"status_code\":410}}">>,
     Req};
gen_body(415, Req, _Reason) ->
    {<<"{\"errors\":{\"message\":\"Usupported media type, currently only application/json is supported.\", \"status_code\":415}}">>,
     Req};
gen_body(500, Req, Reason) ->
    webmachine_log:log_error(500, Req, Reason),
    {<<"{\"errors\":{\"message\":\"Internal server error, the error has been logged.\", \"status_code\":500}}">>,
     Req};
